...
<style>
  ...
  .admin-title { text-align: center; margin-bottom: 20px; color: #fff; }
  .card.admin-form { background: #222; padding: 25px; border-radius: 10px; box-shadow: 0 10px 25px rgba(0,0,0,0.5); color: #fff; border: 1px solid #333; }
  .form-group { margin-bottom: 15px; }
  .form-group label { display: block; font-weight: 600; margin-bottom: 6px; color: #ccc; }
  .form-group input, .form-group select { width: 100%; padding: 10px 12px; border-radius: 6px; border: 1px solid #444; background: #333; color: #fff; font-size: 14px; }
  .form-group input[type="file"] { padding: 6px; background: none; border: none; }
  .btn-primary { width: 100%; padding: 12px; background: #0d6efd; color: #fff; border: none; border-radius: 8px; font-size: 15px; font-weight: 600; cursor: pointer; margin-top: 10px; }
...
<div class="container">
  ...
  <div class="card admin-form">
    <form method="post" enctype="multipart/form-data">
      ...
      <a href="dashboard.php" style="display:block; text-align:center; margin-top:15px; color:#aaa; text-decoration:none;">Cancel</a>
